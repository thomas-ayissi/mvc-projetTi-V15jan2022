...
<head>
  ...
  <title>Galerie</title>
 <link href="../portfolio/apparence/styles/ProjetTiStyle.css" rel="stylesheet" type="text/css">
  <!-- Bootstrap -->
  <link href="../portfolio/decor/pourgalerie/css/bootstrap-4.4.1.css" rel="stylesheet">
</head>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="../portfolio/formes/caroussel1.png" alt="First slide">
                ...
                <div class="carousel-item">
                  <img class="d-block w-100" src="../portfolio/formes/caroussel2.png" alt="Second slide">
                  <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                  <img class="d-block w-100" src="../portfolio/formes/caroussel3.png" alt="Third slide">
                  <div class="carousel-caption d-none d-md-block">
      ...
      <div class="container">
        <div class="row text-center">
          <div class="col-md-4 pb-1 pb-md-0">
            <div class="card">
              <img class="card-img-top" src="../portfolio/formes/violetFoncePourCartesGalerie.png" alt="Card image cap">
              <div class="card-body">

  ...
  <div id="content">
    ...
    ****************************************************************************-->
      ...
      <h3>Curriculum Vitae</h3>
        <div id="bannerImage"><img src="../portfolio/formes/vertPourCv.png" alt=""/></div>
      <hr>
      <div class="row">
        <div class="col-6">
          <h1>Thomas AYISSI</h1>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-12">
          <div class="media">
            <img class="mr-3" src="../portfolio/formes/vertPourCvPetit.png" alt="Generic placeholder image">
